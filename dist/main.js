  ...
  _createClass(Carousel, [{
    ...
    value: function updateSlides() {
      ...
      Array.from(this.dotsContainer.children).forEach(function (dot, i) {
        ...
        dot.classList.toggle('carousel__dot__type_near', i === _this3.slideIndex - 1 || i === _this3.slideIndex + 1);
      });
    }
  }, {
    key: "move",
    value: function move(n) {
      this.slideIndex += n;
      this.slideIndex = Math.max(0, Math.min(this.slideIndex, this.totalSlides - 1));
      this.updateSlides();
    }
  }, {
    key: "startAutoSwipe",
